...
pkglibexecdir = $(libexecdir)/gmrun
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/gmrun.spec.in AUTHORS COPYING ChangeLog INSTALL NEWS \
	README acconfig.h compile install-sh missing mkinstalldirs
...
ACLOCAL = ${SHELL} '/tmp/gmrun/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/tmp/gmrun/missing' autoconf
AUTOHEADER = ${SHELL} '/tmp/gmrun/missing' autoheader
AUTOMAKE = ${SHELL} '/tmp/gmrun/missing' automake-1.16
AWK = gawk
CC = gcc
...
LIBS =  -lpopt
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/tmp/gmrun/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = gmrun
PACKAGE_BUGREPORT = 
PACKAGE_DATA_DIR = ${datarootdir}/gmrun
PACKAGE_NAME = 
PACKAGE_STRING = 
PACKAGE_TARNAME = 
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.9.2
abs_builddir = /tmp/gmrun
abs_srcdir = /tmp/gmrun
abs_top_builddir = /tmp/gmrun
abs_top_srcdir = /tmp/gmrun
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /tmp/gmrun/install-sh
...
gmrun.spec: $(top_builddir)/config.status $(srcdir)/gmrun.spec.in
